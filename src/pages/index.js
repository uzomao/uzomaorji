...
const Index = (props) => {
    ...
    const navigateTo = (route) => {
        ...
        let choice = route === '/terminal' ? 'the techie' : 'the artist'
    ...
    return (
        ...
        <Layout noHeader='true' noFooter='true'>
            <div>
                ...
                <map name="image-map">
                    <area alt="the techie" onClick={() => navigateTo('/terminal')} coords="951,176,975,190,992,200,1010,231,1033,251,1053,278,1056,309,1022,319,1009,353,1015,434,1031,621,1026,644,1029,670,1002,673,994,627,983,584,964,469,958,522,958,552,962,611,957,619,963,644,936,656,909,656,926,601,916,524,911,496,911,412,906,395,918,365,918,321,891,326,868,320,874,284,892,249,906,225" shape="poly" />
